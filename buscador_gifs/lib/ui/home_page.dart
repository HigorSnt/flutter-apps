  ...
  Future<List> _getGifs() async {
    ...
    if (_search == null || _search.isEmpty) {
      response = await http.get(
          "https://api.giphy.com/v1/gifs/trending?api_key=3zGQY3MCvvYSir5NfLrswWjFpdcZgIYL&limit=20&rating=G"
      );
    } else {
      response = await http.get(
          "https://api.giphy.com/v1/gifs/search?api_key=3zGQY3MCvvYSir5NfLrswWjFpdcZgIYL&q=$_search&limit=19&offset=$_offset&rating=G&lang=pt"
      );
    }
